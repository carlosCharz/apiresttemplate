...
public class SwaggerConfig {
		...
		return new Docket(DocumentationType.SWAGGER_2)
														.select()
															.apis(RequestHandlerSelectors.basePackage(
																	"com.wifiesta.apiresttemplate.core.controller"))
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("API REST TEMPLATE API", "App description", "2.0.0", null, contact, null, null, Collections.emptyList());
		return apiInfo;
	}
}
